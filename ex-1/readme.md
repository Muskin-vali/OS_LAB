...
### ECHO $ COMMAND MANUAL 
![echo $ command manual](mecho $home.png)
...
![cat >> command manual](mcat.filename.png)
### CP -R COMMAND OUTPUT
![cp -r command output](cp -r src des.png)
### CP -R COMMAND MANUAL
![cp -r command manual](mcp -r src des.png)
...
### CMP COMMAND OUTPUT
![cmp command output](CMP F1 F2.png)
### CMP COMMAND MANUAL
![cmp command manual](mCMP F1 F2.png)
### CHMOD COMMAND OUTPUT
![chmod command output](chmod 740 file.png)
### CHMOD COMMAND MANUAL
![chmod command manual](mchmod 740 file.png)
